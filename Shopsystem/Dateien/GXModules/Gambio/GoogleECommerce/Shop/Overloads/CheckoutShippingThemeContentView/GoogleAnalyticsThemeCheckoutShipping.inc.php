...
/* --------------------------------------------------------------
  GoogleAnalyticsThemeCheckoutShipping.inc.php 2018-11-15
  Gambio GmbH
  http://www.gambio.de
...
/**
 * Class representing the Google Analytics checkout shipping content view overload
 */
class GoogleAnalyticsThemeCheckoutShipping extends GoogleAnalyticsThemeCheckoutShipping_parent
{
    /**
     * Prepare data
     */
