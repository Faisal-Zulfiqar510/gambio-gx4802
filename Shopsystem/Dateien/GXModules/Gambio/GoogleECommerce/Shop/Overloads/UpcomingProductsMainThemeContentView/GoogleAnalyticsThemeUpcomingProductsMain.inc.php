<?php
/* --------------------------------------------------------------
   GoogleAnalyticsThemeUpcomingProductsMain.inc.php 2018-11-15
   Gambio GmbH
   http://www.gambio.de
...
class GoogleAnalyticsThemeUpcomingProductsMain extends GoogleAnalyticsThemeUpcomingProductsMain_parent
{
    public function prepare_data()
    {
        ...
        $this->content_array['google_analytics_data'] = $trackingService->encodedImpressionsByProductIds(new IdCollection($ids),
                                                                                                         ...
                                                                                                         new NonEmptyStringType($configReadService->listName(GoogleAnalyticsImpressionType::listAvailableSoon())));
    }
}
