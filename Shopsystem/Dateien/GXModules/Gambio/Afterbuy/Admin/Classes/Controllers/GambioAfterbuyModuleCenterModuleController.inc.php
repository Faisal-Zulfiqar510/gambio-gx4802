<?php
/* --------------------------------------------------------------
   GambioAfterbuyModuleCenterModuleController.inc.php 2023-03-28
   Gambio GmbH
   http://www.gambio.de
...
class GambioAfterbuyModuleCenterModuleController extends AbstractModuleCenterModuleController
{
     ...
     * @return void
     */
    protected function saveConfiguration(array $newConfiguration)
    {
        if (isset($newConfiguration['order_status_paid'])) {
            ...
            } elseif(is_array($newConfiguration['order_status_not_paid']) && is_array($newConfiguration['order_status_paid'])) {
