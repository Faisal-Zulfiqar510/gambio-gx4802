<?php
/* --------------------------------------------------------------
   CreateAccountContentControl.inc.php 2022-09-29
   Gambio GmbH
   http://www.gambio.de
...
class CreateAccountContentControl extends DataProcessing
{
    ...
    public function proceed()
    {
        ...
        $this->coo_create_account_content_view = MainFactory::create_object('CreateAccountThemeContentView');
    ...
    protected function create_mail_data_array()
    {
        ...
        if (defined('EMAIL_SIGNATURE') && defined('EMAIL_HTML_SIGNATURE')) {
            $this->mail_data_array['EMAIL_SIGNATURE_HTML'] = EMAIL_HTML_SIGNATURE;
