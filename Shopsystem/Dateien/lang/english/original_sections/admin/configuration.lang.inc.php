<?php
/* --------------------------------------------------------------
	configuration.lang.inc.php 2022-09-26
	Gambio GmbH
	http://www.gambio.de
...
$t_language_text_section_content_array = [
    ...
    'ACCOUNT_CONFIRMATION_EMAIL_TITLE'                => 'Confirm email address',
    'ACCOUNT_CONFIRMATION_EMAIL_DESC'                 => 'Display the field "Enter email again" when creating a customer account',
    ...
    'APPEND_PROPERTIES_MODEL_DESC'                    => 'Append product variants model to the products model instead of replacing it',
    'APPEND_PROPERTIES_MODEL_TITLE'                   => 'Append product variants model',
    'ATTRIBUTE_STOCK_CHECK_DESC'                      => 'Check to see if sufficient product option stock is available',
    'ATTRIBUTE_STOCK_CHECK_TITLE'                     => 'Check product option stock level',
    ...
    'DOWNLOAD_UNALLOWED_PAYMENT_DESC'                 => 'Excluded payment modules for virtual products like downloads.',
    'DOWNLOAD_UNALLOWED_PAYMENT_TITLE'                => 'Excluded Payment Modules',
    ...
    'EMAIL_SIGNATURE_DESC'                            => 'You can use the variable {$EMAIL_SIGNATURE_TEXT} in the e-mail templates to insert this signature',
    'EMAIL_SIGNATURE_TITLE'                           => 'Email Signature in order mail (text only)',
    'EMAIL_HTML_SIGNATURE_DESC'                       => 'You can use the variable {$EMAIL_SIGNATURE_HTML} in the e-mail templates to insert this signature',
    'EMAIL_HTML_SIGNATURE_TITLE'                      => 'Email Signature in order mail (HTML)',
    ...
    'GM_SET_OUT_OF_STOCK_ATTRIBUTES_SHOW_DESC'        => 'Show stock product options',
    'GM_SET_OUT_OF_STOCK_ATTRIBUTES_SHOW_TITLE'       => 'Show stock product options',
    'GM_SET_OUT_OF_STOCK_ATTRIBUTES_TITLE'            => 'Deactivate product options',
    ...
    'MAX_DISPLAY_BESTSELLERS_TITLE'                   => 'Maximum number of best sellers',
    ...
    'MIN_DISPLAY_BESTSELLERS_TITLE'                   => 'Minimum number of best sellers',
    ...
    'SEARCH_IN_ATTR_DESC'                             => 'Activate to enable search in product options and product variants',
    'SEARCH_IN_ATTR_TITLE'                            => 'Search in product options/variants',
    ...
    'SESSION_KEEP_ALIVE_DESC'                         => 'Determines if the session should kept alive.',
    'SESSION_KEEP_ALIVE_TITLE'                        => 'Keep session alive',
    ...
    'SHIPPING_ORIGIN_ZIP_DESC'                        => 'Enter the postcode (ZIP code) of the store.',
    ...
    'SHOW_FULL_SHIPPING_COUNTRY_NAME_DESC'            => 'Shipping country is displayed with full name instead of abbreviation (ISO code)',
    'SHOW_FULL_SHIPPING_COUNTRY_NAME_TITLE'           => 'Show shipping country with full name instead of abbreviation',
    ...
    'NUMBER_OF_CUSTOMERS_PER_PAGE_TITLE'              => 'Number of customers per page',
    'NUMBER_OF_CUSTOMERS_PER_PAGE_DESC'               => 'How many customers should be displayed in the overview per page in Gambio Admin?',
    'NUMBER_OF_ORDERS_PER_PAGE_TITLE'                 => 'Number of orders per page',
    'NUMBER_OF_ORDERS_PER_PAGE_DESC'                  => 'How many orders should be displayed in the overview per page in Gambio Admin',
    'NUMBER_OF_PRODUCTS_PER_PAGE_TITLE'               => 'Number of products per page',
    'NUMBER_OF_PRODUCTS_PER_PAGE_DESC'                => 'How many products should be displayed in the overview per page in Gambio Admin',
    'USE_APILAYER_API_KEY_TITLE'                      => 'APILayer API key for exchange rate updates',
    'USE_APILAYER_API_KEY_DESC'                       => 'To be able to update exchange rates, you need an APILayer account, which you can create at https://apilayer.com. In the account you will find the API key, which has to be entered here. You also need to subscribe to the Exchange Rates Data API https://apilayer.com/marketplace/exchangerates_data-api (available for free).',
    'SERVICE_WITHOUT_SHIPPING_TITLE'                  => 'Skip shipping method selection for services',
    'SERVICE_WITHOUT_SHIPPING_DESC'                   => 'If there are only service items in the shopping cart, the selection of the shipping method is skipped in the ordering process',
];
