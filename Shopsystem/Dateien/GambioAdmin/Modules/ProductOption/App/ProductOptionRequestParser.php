<?php
/*--------------------------------------------------------------
   ProductOptionRequestParser.php 2022-10-21
   Gambio GmbH
   http://www.gambio.de
 ...
 */
class ProductOptionRequestParser
{
    /**
    ...
    private function getCreationDataFromDocumentBody(array $documentData, int $productId): array
    {
        return [
            ...
            $this->factory->createOptionValueCustomization(strip_tags($documentData['modelNumber']),
                                                           $documentData['weight'],
                                                           $documentData['price']),
            $this->factory->createProductOptionStock($documentData['stock'], $documentData['stockType']),
