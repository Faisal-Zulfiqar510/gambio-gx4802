<?php
/*--------------------------------------------------------------
   FetchSpecificProductOptionAction.php 2021-10-27
   Gambio GmbH
   http://www.gambio.de
 ...
 */
class FetchSpecificProductOptionAction extends AbstractProductOptionAction
{
    /**
    ...
    public function handle(Request $request, Response $response): Response
    {
        try {
            ...
            $productOption   = $this->productOptionReadService->getProductOptionById($productOptionId);
            $json            = [];
            
            if (in_array($productOption->id(), $this->downloadProductOptionIds(), true)) {
                
                throw ProductOptionDoesNotExistException::forProductOptionId($productOption->id());
            }
        ...
        } catch (ProductOptionDoesNotExistException | OptionDoesNotExistException $exception) {
