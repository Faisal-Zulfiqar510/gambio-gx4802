<?php
/*--------------------------------------------------------------------
 ProductOptionFloatConverter.php 2021-09-01
 Gambio GmbH
 http://www.gambio.de
...
namespace Gambio\Admin\Modules\ProductDownload\App\Data\Traits;

/**
 * Trait ProductOptionFloatConverter
 * @package Gambio\Admin\Modules\ProductDownload\App\Data\Traits
 */
trait ProductDownloadFloatConverter
{
    /**
     * @param float $value
     *
