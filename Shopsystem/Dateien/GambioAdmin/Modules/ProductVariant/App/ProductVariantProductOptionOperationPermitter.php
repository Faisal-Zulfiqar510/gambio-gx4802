<?php
/*--------------------------------------------------------------
   ProductVariantProductOptionOperationPermitter.php 2021-10-12
   Gambio GmbH
   http://www.gambio.de
 ...
 */
class ProductVariantProductOptionOperationPermitter implements ProductOptionOperationPermitter
{
    /**
     ...
     */
    public function __construct(ProductVariantsReader $readService)
    {
