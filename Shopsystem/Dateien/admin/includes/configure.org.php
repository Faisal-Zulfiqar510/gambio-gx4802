...
define('HTTP_SERVER', 'http://fuzzy-spoon-4vjpvrwwwr6fqj46-8080.app.github.dev'); // eg, http://localhost or - https://localhost should not be empty for productive servers
define('HTTP_CATALOG_SERVER', 'http://fuzzy-spoon-4vjpvrwwwr6fqj46-8080.app.github.dev');
