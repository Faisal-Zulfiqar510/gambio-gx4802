...
// Normalize proxy headers (Codespaces/reverse-proxy) before URL and SSL checks.
...
{
	$t_document_root = '/app/'; // absolute server path required (domain root)
}
...
define('HTTP_SERVER', 'https://fuzzy-spoon-4vjpvrwwwr6fqj46-8080.app.github.dev'); // eg, http://localhost or - https://localhost should not be empty for productive servers
define('HTTP_CATALOG_SERVER', 'https://fuzzy-spoon-4vjpvrwwwr6fqj46-8080.app.github.dev');
define('HTTPS_CATALOG_SERVER', 'https://fuzzy-spoon-4vjpvrwwwr6fqj46-8080.app.github.dev');
...
//define('DB_SERVER_USERNAME', 'gambio');
//define('DB_SERVER_PASSWORD', 'gambio');
...
define_database('db', // eg, localhost - should not be empty for productive servers
                'gambio',
                'gambio',
                'gambio',
