<?php
/* --------------------------------------------------------------
  product_reviews_info.php 2022-08-04
  Gambio GmbH
  http://www.gambio.de
...
{
	$coo_product_reviews_info_control->set_('review_id', (int)$_GET['reviews_id']);
}
$coo_product_reviews_info_control->set_('language_id', (int)($_SESSION['languages_id'] ?? null));
