<?php
/* --------------------------------------------------------------
   AttachmentsHandler.inc.php 2022-05-18 gm
   Gambio GmbH
   http://www.gambio.de
...
class AttachmentsHandler implements AttachmentsHandlerInterface
{
     ...
     */
    private function checkAttachmentHash(AttachmentConfigurationInterface $attachmentConfiguration): bool
    {
     ...
     */
    private function getAttachmentConfigurationFactory()
    {
