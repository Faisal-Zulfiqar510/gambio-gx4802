...
define('HTTP_SERVER', 'https://fuzzy-spoon-4vjpvrwwwr6fqj46-8080.app.github.dev'); // eg, http://localhost - should not be empty for productive servers
define('HTTPS_SERVER', 'https://fuzzy-spoon-4vjpvrwwwr6fqj46-8080.app.github.dev'); // eg, https://localhost - should not be empty for productive servers
